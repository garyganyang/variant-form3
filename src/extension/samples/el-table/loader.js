...
import MyWidget from "./el-table-widget.vue";
...
export const loadElTableWidget = (app) => {
    /**
     * 加载字段组件步骤：
     * 1. 加载组件Json Schema;
    ...
    PERegister.registerCPEditor(app, 'el-table-border', 'el-table-border-editor',
        PEFactory.createBooleanEditor('border', 'extension.setting.border'))

    PERegister.registerCPEditor(app, 'el-table-tableHeight', 'el-table-tableHeight-editor',
        PEFactory.createInputTextEditor('tableHeight', 'extension.setting.tableHeight', "px或%或calc"))

    PERegister.registerCPEditor(app, 'el-table-columnList', 'el-table-columnList-editor',)
    PERegister.registerCPEditor(app, 'el-table-actionList', 'el-table-actionList-editor',)
    ...
    PERegister.registerEPEditor(app, 'el-table-onRowClick', 'el-table-onRowClick-editor',
        PEFactory.createEventHandlerEditor('onRowClick', ['row', 'column', 'event']))

    PERegister.registerEPEditor(app, 'el-table-onRowDoubleClick', 'el-table-onRowDoubleClick-editor',
        PEFactory.createEventHandlerEditor('onRowDoubleClick', ['row', 'column', 'event']))

    PERegister.registerEPEditor(app, 'el-table-onCellClick', 'el-table-onCellClick-editor',
        PEFactory.createEventHandlerEditor('onCellClick', ['row', 'column', 'cell', 'event']))

    PERegister.registerEPEditor(app, 'el-table-onCellDoubleClick', 'el-table-onCellDoubleClick-editor',
        PEFactory.createEventHandlerEditor('onCellDoubleClick', ['row', 'column', 'cell', 'event']))

    PERegister.registerEPEditor(app, 'el-table-onPageSizeChange', 'el-table-onPageSizeChange-editor',
