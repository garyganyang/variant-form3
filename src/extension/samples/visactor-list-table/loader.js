...
import MyWidget from "./list-table-widget.vue";
...
export const loadVisactorListTableWidget = (app) => {
    /**
     * 加载字段组件步骤：
     * 1. 加载组件Json Schema;
    ...
    PERegister.registerCPEditor(app, 'v-list-table-tableHeight', 'v-list-table-tableHeight-editor',
