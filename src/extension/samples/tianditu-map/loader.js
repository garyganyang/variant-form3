...
import MyWidget from "./tianditu-map-widget.vue";
...
export const loadTiandituMapWidget = (app) => {
    /**
     * 加载字段组件步骤：
     * 1. 加载组件Json Schema;
    ...
    // PERegister.registerCPEditor(app, 'v-list-table-border', 'v-list-table-border-editor',
    //     PEFactory.createBooleanEditor('border', 'extension.setting.border'))

    PERegister.registerCPEditor(app, 'tianditu-map-width', 'tianditu-map-width-editor',
        PEFactory.createInputTextEditor('width', 'extension.setting.width', "px、%、calc", true))

    PERegister.registerCPEditor(app, 'tianditu-map-height', 'tianditu-map-height-editor',
        PEFactory.createInputTextEditor('height', 'extension.setting.height', "px、%、calc", true))

    PERegister.registerCPEditor(app, 'tianditu-map-tdtKey', 'tianditu-map-tdtKey-editor',
      PEFactory.createInputTextEditor('tdtKey', 'extension.setting.tdtKey', '天地图key', true))

    // PERegister.registerCPEditor(app, 'v-list-table-columnList', 'v-list-table-columnList-editor',)
    // PERegister.registerCPEditor(app, 'v-list-table-actionList', 'v-list-table-actionList-editor',)
    //
    // PERegister.registerCPEditor(app, 'v-list-table-actionColumnFixedWidth', 'v-list-table-actionColumnFixedWidth-editor',
    //     PEFactory.createInputTextEditor('actionColumnFixedWidth', 'extension.setting.actionColumnFixedWidth', "操作列固定宽度"))
    //
    // PERegister.registerEPEditor(app, 'v-list-table-onHeaderClick', 'v-list-table-onHeaderClick-editor',
    //     PEFactory.createEventHandlerEditor('onHeaderClick', ['column', 'event']))
    //
    // PERegister.registerEPEditor(app, 'v-list-table-onRowClick', 'v-list-table-onRowClick-editor',
    //     PEFactory.createEventHandlerEditor('onRowClick', ['row', 'column', 'event']))
    //
    // PERegister.registerEPEditor(app, 'v-list-table-onRowDoubleClick', 'v-list-table-onRowDoubleClick-editor',
    //     PEFactory.createEventHandlerEditor('onRowDoubleClick', ['row', 'column', 'event']))
    //
    // PERegister.registerEPEditor(app, 'v-list-table-onCellClick', 'v-list-table-onCellClick-editor',
    //     PEFactory.createEventHandlerEditor('onCellClick', ['row', 'column', 'cell', 'event']))
    //
    // PERegister.registerEPEditor(app, 'v-list-table-onCellDoubleClick', 'v-list-table-onCellDoubleClick-editor',
    //     PEFactory.createEventHandlerEditor('onCellDoubleClick', ['row', 'column', 'cell', 'event']))
    //
    // PERegister.registerEPEditor(app, 'v-list-table-onPageSizeChange', 'v-list-table-onPageSizeChange-editor',
    //     PEFactory.createEventHandlerEditor('onPageSizeChange', ['pageNum', 'pageSize']))
    //
    // PERegister.registerEPEditor(app, 'v-list-table-onPageNumChange', 'v-list-table-onPageNumChange-editor',
