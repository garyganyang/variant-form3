            ...
            "actionList": [
              {
                ...
                "isDisableButton": "// 获取全局的对象,即可以调用对应方法,例如判断全局权限\n// const ref = window[this.formConfig.formUniqueId];\nreturn false;",
                "isHideButton": "// 获取全局的对象,即可以调用对应方法,例如判断全局权限\n// const ref = window[this.formConfig.formUniqueId];\nreturn true;",
                "isHiddenButton": "// 获取全局的对象,即可以调用对应方法,例如判断全局权限\n// const ref = window[this.formConfig.formUniqueId];\nreturn false;"
              },
              {
                "seq": 1,
                "prop": "delBtn",
                ...
                "label": "删除",
                "isShow": true,
                "onClick": "window['t-blablabla'].deleteRecord(row)",
                "isCollapsed": false,
                "requireConfirm": true,
                "isDisableButton": "// 获取全局的对象,即可以调用对应方法,例如判断全局权限\n// const ref = window[this.formConfig.formUniqueId];\nreturn false;",
                "isHideButton": "// 获取全局的对象,即可以调用对应方法,例如判断全局权限\n// const ref = window[this.formConfig.formUniqueId];\nreturn false;",
  ...
  },
  {
    ...
    metadata: {
              ...
              "widgetList": [
                {
                  ...
                  "options": {
                    ...
                    "circle": false,
                    "hidden": false,
                    "onClick": "this.hideCustomizedDialog()",
                    "disabled": false,
                    "onCreated": "",
                    "onMounted": "",
                    "columnWidth": "200px",
                ...
                },
                {
                  ...
                  "options": {
                    ...
                    "circle": false,
                    "hidden": false,
                    "onClick": "// 本onClick方法已具备防抖功能:\n// 300ms延迟, 点击立刻执行一次, 停止点击后不再额外执行.\n\n// 一些常用方法\n// this.setLoading(true) 忙等\n// this.hideCustomizedDialog() 关闭当前对话框\n// this.hideCustomizedDialog('getTableData(1)') 关闭当前对话框后, 默认调用父表单对象的getTableData(1)方法, 方法名可任意\n\n// 按钮点击后, 关闭页面, 通知父页面调用其getTableData方法, \n// 并根据新增/编辑与否来确定跳转哪一页.\ndebugger\nthis.setLoading(true)\nwindow[this.formConfig.formUniqueId].submitForm(this, res=>{\n   this.setLoading(false)\n  // if(this.formData && this.formData.id){\n  //   this.hideCustomizedDialog('getTableData(1)')\n  // }else{\n  //   this.hideCustomizedDialog('getTableData()')\n  // }\n})\n",
                    "disabled": false,
                    "onCreated": "",
                    "onMounted": "",
                    "columnWidth": "200px",
      ...
      "formConfig": {
        ...
        "size": "",
        "labelAlign": "label-right-align",
        "cssCode": ".flex{display: flex;align-items: center;}\n.flex1{flex:1}\n.ml-8{margin-left:8px;}\n.mr-8{margin-right:8px;}\n.mt-8{margin-top:8px;}\n.mb-8{margin-bottom:8px;}\n.ml-16{margin-left:16px;}\n.mr-16{margin-right:16px;}\n.mt-16{margin-top:16px;}\n.mb-16{margin-bottom:16px;}\n.text-center{text-align:center}\n.text-right{text-align:right}\n.w-full{width:100%}\n.w-full{width:100%}\n.h-full{height:100%}",
        "customClass": [],
        "functions": "/***\n * 1. localstorage部分\n * 全局提供 $localstoraged 对象\n * $localStorage.getToken()\n * $localStorage.getTenantCode()\n * $localStorage.getTenantInfo()\n * $localStorage.getENC()\n * $localStorage.getMyProfile()\n * $localStorage.getCurApplicationInfo()\n * $localStorage.set({ name, content, type })\n * $localStorage.get(name)\n *\n * ****************************************************************************\n *\n * 2. axios 部分\n * 全局提供$axios对象, 此对象已增强，有request和response的拦截器功能\n * 若要为axios设置全局header：\n * const token = $localStorage.getToken();\n * $axios.defaults.headers.common['Authorization'] = `Bearer ${token}`;\n * $axios.getAction(url = '', param = {})\n * $axios.postAction(url = '', data = {}, config = {})\n * $axios.putAction(url = '', data = {}, config = {})\n * $axios.deleteAction(url = '', config = {})\n * $axios.downloadAction(params = '') ????? /epms/file/proxyDown?` + params\n *\n * ****************************************************************************\n *\n * 3. fieldModel 部分\n * 每一个组件都有自己的 fieldModel, 里面存储了他的值, 大部分都是一个简单的对象, 只有一个值\n * 通过 getValue() setValue() 即可操作\n * 但有些组件例外,特别是自定义组件:\n * 自定义组件【el-table】的fieldModel结构为\n * {\n *         loading: false,\n *         pageSize: 10,\n *         pageNum: 1,\n *         totalElements: 0,\n *         data: [],\n * }\n * 可以使用 获取值 :getValue(),  fieldModel.pageNum, 和设置值 fieldModel.pageNum = 1\n *\n */\ndebugger\n// ========== 【axios 全局的】 ==========\nvar token = $localStorage.getToken();\n$axios.defaults.headers.common['Authorization'] = `Bearer ${token}`;\n$axios.defaults.baseURL = '/epms2-api'\n$axios.defaults.timeout = 10 * 1000\n\n// ========== 【表单全局命名】 ==========\nvar UNIQUE_FORM_CODE = 'form01821';\n\n// ========== 【表单全局函数】 整个表单全局函数，只声明 一个 对象！==========\nwindow[UNIQUE_FORM_CODE] = {\n    PRIMARY_DATA_TABLE_NAME: \"drone\", // 数据表的唯一名称, 若有数据表.\n    PRIMARY_DATA_TABLE_CODE: \"drone\", // 数据表(在线数据表)的code, 用于接口调用, 若有数据表.\n\n    formRef: null,\n    dialogFormSchema: null,\n    setFormRef(ref) {\n        this.formRef = ref // 在form的onMounted里面调用setFormRef(this)来设置formRef\n    },\n    // 表单提交函数\n    submitForm(widgetRef, callbackFun){\n      debugger;\n      const needValidation = true\n      this.formRef.getFormData(needValidation).then(res => {\n        const data = {\n          \"data\":{\n            \"tableCode\": this.PRIMARY_DATA_TABLE_CODE,\n            \"content\": {\n              ...res\n            },\n            \"childContentList\": [],\n            \"clearTable\": []\n          }\n        }\n        $axios.postAction('/api/form/FormDynamicTransactor.save.command', data, {}).then(response => {\n          if (!response.data.exception) {\n            this.formRef.$message.success('操作成功')\n          } else {          \n            this.formRef.$message.error(response.data.message)\n          }\n          callbackFun(response.data)\n        })\n      }).catch((e) => {\n        // 表单验证的异常会在这里\n        widgetRef.setLoading(false)\n      }).finally(() => {\n        \n      }) \n    },\n    // 任何调用this.formRef.validateForm(callback) 都会调用这个extraValidate\n    extraValidate(){\n      // this.formRef.blablabla\n      return true // validate的结果, 默认返回true\n    }\n\n}\n\n// 表单相关属性\n// this.formConfig\n// this.formData\n// this.formDataModel\n// this.formId\n// this.formJson\n// this.formJsonObj\n// this.globalDsv;\n// this.labelPosition;\n// this.labelWidth;\n// this.optionData;\n// this.previewState;\n// this.size;\n// this.subFormRefList;\n// this.vfEvents;\n// this.widgetList;\n// this.widgetRefList;\n\n// 表单相关方法\n// this.addEC();\n// this.addFieldChangeEventHandler();\n// this.addFieldValidateEventHandler();\n// this.broadcast();\n// this.buildDataFromWidget();\n// this.buildFormModel();\n// this.changeLanguage();\n// this.clearFormDataModel();\n// this.clearValidate();\n// this.disableForm();\n// this.disableWidgets();\n// this.dispatch();\n// this.emit$();\n// this.enableForm();\n// this.enableWidgets();\n// this.findWidgetAndSetDisabled();\n// this.findWidgetAndSetHidden();\n// this.findWidgetNameInSubForm();\n// this.findWidgetOfSubFormAndSetDisabled();\n// this.findWidgetOfSubFormAndSetHidden();\n// this.getContainerWidgetName();\n// this.getContainerWidgets();\n// this.getEC();\n// this.getFieldValue();\n// this.getFieldWidgets();\n// this.getFormData(); return Promise\n// this.getFormRef();\n// this.getGlobalDsv();\n// this.getNativeForm();\n// this.getSubFormValues();\n// this.getWidgetName();\n// this.getWidgetRef();\n// this.handleFieldDataChange();\n// this.handleOnCreated();\n// this.handleOnMounted();\n// this.hasEC();\n// this.hideWidgets();\n// this.i18n2t();\n// this.i18nt();\n// this.initFormObject();\n// this.initLocale();\n// this.insertCustomStyleAndScriptNode();\n// this.registerCustomizedDialog();\n// this.registerFormToRefList();\n// this.reloadOptionData();\n// this.resetForm();\n// this.setFieldValue();\n// this.setFormData();\n// this.setFormJson();\n// this.showWidgets();\n// this.validateFields();\n// this.validateForm();",
        "layoutType": "PC",
        "jsonVersion": 3,
        "onFormCreated": "// 表单相关属性\n// this.formConfig\n// this.formData\n// this.formDataModel\n// this.formId\n// this.formJson\n// this.formJsonObj\n// this.globalDsv;\n// this.labelPosition;\n// this.labelWidth;\n// this.optionData;\n// this.previewState;\n// this.size;\n// this.subFormRefList;\n// this.vfEvents;\n// this.widgetList;\n// this.widgetRefList;\n\n// 表单相关方法\n// this.addEC();\n// this.addFieldChangeEventHandler();\n// this.addFieldValidateEventHandler();\n// this.broadcast();\n// this.buildDataFromWidget();\n// this.buildFormModel();\n// this.changeLanguage();\n// this.clearFormDataModel();\n// this.clearValidate();\n// this.disableForm();\n// this.disableWidgets();\n// this.dispatch();\n// this.emit$();\n// this.enableForm();\n// this.enableWidgets();\n// this.findWidgetAndSetDisabled();\n// this.findWidgetAndSetHidden();\n// this.findWidgetNameInSubForm();\n// this.findWidgetOfSubFormAndSetDisabled();\n// this.findWidgetOfSubFormAndSetHidden();\n// this.getContainerWidgetName();\n// this.getContainerWidgets();\n// this.getEC();\n// this.getFieldValue();\n// this.getFieldWidgets();\n// this.getFormData();\n// this.getFormRef();\n// this.getGlobalDsv();\n// this.getNativeForm();\n// this.getSubFormValues();\n// this.getWidgetName();\n// this.getWidgetRef();\n// this.handleFieldDataChange();\n// this.handleOnCreated();\n// this.handleOnMounted();\n// this.hasEC();\n// this.hideWidgets();\n// this.i18n2t();\n// this.i18nt();\n// this.initFormObject();\n// this.initLocale();\n// this.insertCustomStyleAndScriptNode();\n// this.registerCustomizedDialog();\n// this.registerFormToRefList();\n// this.reloadOptionData();\n// this.resetForm();\n// this.setFieldValue();\n// this.setFormData();\n// this.setFormJson();\n// this.showWidgets();\n// this.validateFields();\n// this.validateForm();",
        "onFormMounted": "debugger\n// 必须要执行的 setFormRef(this)\nwindow[this.formConfig.formUniqueId].setFormRef(this)\n\n\n// 获取表单裸数据(一般来说, 就是传给showCustomizedDialog的dialogFormData)\nthis.getFormRef(\"v_form_ref\").formRawData\n// 获取表单数据(受制于页面配置了哪些字段, 也是双向绑定的字段)\nthis.formDataModel\n\n// 表单相关属性\n// this.formConfig\n// this.formData\n// this.formDataModel\n// this.formId\n// this.formJson\n// this.formJsonObj\n// this.globalDsv;\n// this.labelPosition;\n// this.labelWidth;\n// this.optionData;\n// this.previewState;\n// this.size;\n// this.subFormRefList;\n// this.vfEvents;\n// this.widgetList;\n// this.widgetRefList;\n\n// 表单相关方法\n// this.addEC();\n// this.addFieldChangeEventHandler();\n// this.addFieldValidateEventHandler();\n// this.broadcast();\n// this.buildDataFromWidget();\n// this.buildFormModel();\n// this.changeLanguage();\n// this.clearFormDataModel();\n// this.clearValidate();\n// this.disableForm();\n// this.disableWidgets();\n// this.dispatch();\n// this.emit$();\n// this.enableForm();\n// this.enableWidgets();\n// this.findWidgetAndSetDisabled();\n// this.findWidgetAndSetHidden();\n// this.findWidgetNameInSubForm();\n// this.findWidgetOfSubFormAndSetDisabled();\n// this.findWidgetOfSubFormAndSetHidden();\n// this.getContainerWidgetName();\n// this.getContainerWidgets();\n// this.getEC();\n// this.getFieldValue();\n// this.getFieldWidgets();\n// this.getFormData(); return Promise\n// this.getFormRef();\n// this.getGlobalDsv();\n// this.getNativeForm();\n// this.getSubFormValues();\n// this.getWidgetName();\n// this.getWidgetRef();\n// this.handleFieldDataChange();\n// this.handleOnCreated();\n// this.handleOnMounted();\n// this.hasEC();\n// this.hideWidgets();\n// this.i18n2t();\n// this.i18nt();\n// this.initFormObject();\n// this.initLocale();\n// this.insertCustomStyleAndScriptNode();\n// this.registerCustomizedDialog();\n// this.registerFormToRefList();\n// this.reloadOptionData();\n// this.resetForm();\n// this.setFieldValue();\n// this.setFormData();\n// this.setFormJson();\n// this.showWidgets();\n// this.validateFields();\n// this.validateForm();",
        "onFormDataChange": "// 表单相关属性\n// this.formConfig\n// this.formData\n// this.formDataModel\n// this.formId\n// this.formJson\n// this.formJsonObj\n// this.globalDsv;\n// this.labelPosition;\n// this.labelWidth;\n// this.optionData;\n// this.previewState;\n// this.size;\n// this.subFormRefList;\n// this.vfEvents;\n// this.widgetList;\n// this.widgetRefList;\n\n// 表单相关方法\n// this.addEC();\n// this.addFieldChangeEventHandler();\n// this.addFieldValidateEventHandler();\n// this.broadcast();\n// this.buildDataFromWidget();\n// this.buildFormModel();\n// this.changeLanguage();\n// this.clearFormDataModel();\n// this.clearValidate();\n// this.disableForm();\n// this.disableWidgets();\n// this.dispatch();\n// this.emit$();\n// this.enableForm();\n// this.enableWidgets();\n// this.findWidgetAndSetDisabled();\n// this.findWidgetAndSetHidden();\n// this.findWidgetNameInSubForm();\n// this.findWidgetOfSubFormAndSetDisabled();\n// this.findWidgetOfSubFormAndSetHidden();\n// this.getContainerWidgetName();\n// this.getContainerWidgets();\n// this.getEC();\n// this.getFieldValue();\n// this.getFieldWidgets();\n// this.getFormData();\n// this.getFormRef();\n// this.getGlobalDsv();\n// this.getNativeForm();\n// this.getSubFormValues();\n// this.getWidgetName();\n// this.getWidgetRef();\n// this.handleFieldDataChange();\n// this.handleOnCreated();\n// this.handleOnMounted();\n// this.hasEC();\n// this.hideWidgets();\n// this.i18n2t();\n// this.i18nt();\n// this.initFormObject();\n// this.initLocale();\n// this.insertCustomStyleAndScriptNode();\n// this.registerCustomizedDialog();\n// this.registerFormToRefList();\n// this.reloadOptionData();\n// this.resetForm();\n// this.setFieldValue();\n// this.setFormData();\n// this.setFormJson();\n// this.showWidgets();\n// this.validateFields();\n// this.validateForm();",
        "onFormValidate": "",
        "describe": "",
        "formName": "",
        "tableCode": "",
        "onFormDestoryed": "",
        "formUniqueId": "form01821"
      }
    }
  }
